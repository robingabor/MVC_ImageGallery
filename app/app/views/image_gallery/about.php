...
<?php $this->view("image_gallery/header",$data); ?>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="<?=ASSETS?>image_gallery/img/hero.jpg"></div>
    ...
    <div class="container-fluid tm-mt-60">
        ...
        <div class="row tm-mb-74 tm-row-1640">            
            <div class="col-lg-5 col-md-6 col-12 mb-3">
                <img src="<?=ASSETS?>image_gallery/img/about.jpg" alt="Image" class="img-fluid">
            </div>
